...
-----
    ...
    python idledips.py                       # the before-repair idle table
...
# afterwards is taken with them unchanged. The prediction they pinned down is
# in the module docstring; the idle was not cured, so they stay frozen to keep
# readings comparable across the repair.
#
